...
const STRINGS = {
  en: {
    ...
    'key.title': 'AI keys', 'key.openai': 'OpenAI', 'key.anthropic': 'Anthropic',
    'key.openaiWhat': 'The talking tutor and word audio.',
    'key.anthropicWhat': 'Word checking, handwriting and song lessons.',
    'key.set': 'Set', 'key.change': 'Replace', 'key.remove': 'Remove',
    'key.none': 'Not set', 'key.fromServer': 'Using the server key',
    'key.paste': 'Paste your key',
    'key.hint': 'Kept encrypted on the server and never sent back to this device. Only you are billed for what you use.',
    'key.checking': 'Checking the key…', 'key.saved': 'Key saved',
    'key.getOpenai': 'Get one at platform.openai.com/api-keys',
    'key.getAnthropic': 'Get one at console.anthropic.com',
    'err.key_format': 'That does not look like a key for this provider.',
    'err.key_rejected': 'The provider rejected that key.',
  ...
  pl: {
    ...
    'key.title': 'Klucze AI', 'key.openai': 'OpenAI', 'key.anthropic': 'Anthropic',
    'key.openaiWhat': 'Rozmowa z nauczycielem i wymowa słów.',
    'key.anthropicWhat': 'Sprawdzanie słów, pismo odręczne i lekcje z piosenek.',
    'key.set': 'Ustaw', 'key.change': 'Zmień', 'key.remove': 'Usuń',
    'key.none': 'Nie ustawiono', 'key.fromServer': 'Używa klucza serwera',
    'key.paste': 'Wklej swój klucz',
    'key.hint': 'Trzymany zaszyfrowany na serwerze i nigdy nie odsyłany na to urządzenie. Płacisz tylko ty, za to czego użyjesz.',
    'key.checking': 'Sprawdzam klucz…', 'key.saved': 'Zapisano klucz',
    'key.getOpenai': 'Zdobądź go na platform.openai.com/api-keys',
    'key.getAnthropic': 'Zdobądź go na console.anthropic.com',
    'err.key_format': 'To nie wygląda na klucz tego dostawcy.',
